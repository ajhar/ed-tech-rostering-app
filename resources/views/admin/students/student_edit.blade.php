<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title mt-0">Edit Student</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <form method="PUT" action="{{route('students.update',$student->id)}}" id="student-form" novalidate>
            @csrf
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="registration_number" class="form-control"
                               id="input-registration-number" value="{{$student->registration_number}}" required>
                        <div class="invalid-feedback" id="registration-number-error"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="input-subject-id">Class</label>
                        <select class="selectize" name="class_id" id="input-class-id">
                            @foreach($classes as $class)
                                <option
                                    value="{{$class->id}}" {{$student->classRoom->id == $class->id ? 'selected':''}}>
                                    {{$class->name}}
                                </option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback" id="class-id-error"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="input-subject-id">Activities</label>
                        <select class="selectize" name="activity_ids[]" id="input-activity-ids" multiple>
                            @foreach($activities as $activity)
                                <option
                                    value="{{$activity->id}}" {{$student->studentActivities->contains('activity_id',$activity->id)?'selected':''}}>
                                    {{$activity->name}}
                                </option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback" id="activity-ids-error"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="street1" class="form-control" id="input-street1"
                               value="{{$student->userAttribute->street1}}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="street2" class="form-control" id="input-street1"
                               value="{{$student->userAttribute->street2}}" required>
                        <div class="invalid-feedback" id="street1-error"></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="selectize" name="country_id" id="input-country-id">
                            @foreach($countries as $country)
                                <option
                                    value="{{$country->id}}" {{$student->userAttribute->country_id == $country->id ?'selected':''}}>
                                    {{$country->name}}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="phone_number" class="form-control" id="input-phone-number"
                               value="{{$student->userAttribute->phone_number}}">
